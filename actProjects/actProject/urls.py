...
urlpatterns = [
    ...
    path('api/search/play/<str:type>', App.views.search_detail, name='search_detail'), # 검색결과페이지, 더보기 클릭
    ...
    path('api/troupes/<int:id>/like',
         App.views.troupelike, name='troupelike'),  # 극단찜하기
