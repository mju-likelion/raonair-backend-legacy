...
urlpatterns = [
    ...
    path('api/search/', App.views.serch, name="serch"),  # 검색결과페이지
    path('api/search/:category', App.views.serch_detail, name="serch_detail"),  # 검색결과페이지, 더보기 클릭
    path('api/troupe/:id', App.views.troupe, name="troupe"),  # 극단개별페이지
    path('api/play/:id', App.views.play, name="play"),  # 연극개별페이지
    ...
    path('api/plays/:id/ratings', App.views.star, name="star"),  # 별점
