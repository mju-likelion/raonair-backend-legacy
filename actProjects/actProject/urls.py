...
urlpatterns = [
    ...
    path('api/search/play', App.views.search_play, name='search_play'),  # 검색결과페이지
    path('api/search/troupe', App.views.search_troupe, name='search_troupe'),  # 검색결과페이지
    path('api/search/play/<str:type>', App.views.search_detail, name="search_detail"),  # 공연 검색결과페이지, 더보기 클릭
    path('api/search/troupe/detail', App.views.search_troupe_detail, name="search_troupe_detail"),  # 극단 검색결과페이지, 더보기 클릭
